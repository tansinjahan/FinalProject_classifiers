...
def generate_plot_for_HoKashyap(class1,class2,plot_x,plot_y):
...
def generate_plot_for_discriminantFunc(plotX1,plotX2,Points_X1_X2,Root4,Root3,Points_X1_X3,Root1,Root2):
    ...
    #plt.scatter(Points_X1_X2[:], Root3[:], c='orange')
    ...
    #plt.scatter(Points_X1_X3[:], Root2[:], c='orange')
...
def generate_plot_for_parzen_class1(random_points,f_class,):
    plt.title("Final learned distribution of features of class 1")
...
def generate_plot_for_parzen_class2(random_points,f_class,):
    plt.title("Final learned distribution of features of class 2")
